...
export default function Footer() {
  return (
    <footer className="bg-navy border-t-4 border-red text-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {/* Brand */}
          <div>
            <h3 className="headline-stamp text-white text-2xl mb-3">{SITE_NAME}</h3>
            <p className="typewriter-accent text-silver text-sm">{SITE_TAGLINE}</p>
          </div>

          {/* Navigation */}
          <div>
            <h4 className="headline-stamp text-silver text-sm mb-4 tracking-widest">Navigate</h4>
          ...
          {/* Contact */}
          <div>
            <h4 className="headline-stamp text-silver text-sm mb-4 tracking-widest">Connect</h4>
